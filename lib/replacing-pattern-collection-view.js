...
export default class ReplacingPatternCollectionView {
  ...
  makeMiniEditors() {
    ...
    this.discriptionEditor = makeMiniEditorWithView('', [RPC.name]);
  ...
  makeRootElement() {
    this.rootElement = makeHTML([RPC.name], {tag: 'div', class: 'root'},
      [[], {tag: 'div'},
        [[], {tag: 'div', class: 'block'},
          this.closeButton, this.readFromButton, this.writeToButton
        ],
        ...
        [[], {tag: 'table'},
          [[], {tag: 'tr'},
            ...
            [[], {tag: 'td', class: 'right'},
              [[], {tag: 'span', textContent: 'discription:', class: 'discription'},
                this.discriptionEditor.view],
  ...
  setTabIndex() {
    ...
    this.discriptionEditor.view.tabIndex = ++i;
  ...
  setEditorDidChange() {
    ...
    this.subscriptions.add(
      this.discriptionEditor.onDidStopChanging(this.onChangeCurrentOption(this.discriptionEditor, "discription"))
    );
    this.subscriptions.add(
  ...
  updateView() {
    ...
    this.discriptionEditor.setText(this.currentOption.discription);
